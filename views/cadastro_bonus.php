...
<head>
    ...
    <title>Gerenciador Financeiro - Cadastro de Bônus</title>
    <!-- Font Awesome -->
        ...
        <div class="form-row">
            <div class="form-group col-md-6" id="form-cadastro-valores">
                ...
                <div class="card">
                    ...
                    <h5 class="card-header white-text text-center py-4" style="background-color: #00BE4E;">
                        <strong>Novo Bônus</strong>
                    </h5>
                    ...
                    <div class="card-body px-lg-5 pt-0">
                        ...
                        <form class="text-center" style="color: #757575;">
                            ...
                            <!-- Send button -->
                            <button class="btn btn-block my-4" style="background-color: #00BE4E;" type="submit">Salvar</button>
